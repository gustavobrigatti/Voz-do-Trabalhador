        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    <h3 class="title has-text-grey">Tela de Login</h3>
                                    ...
                                    <form action="../bd/login/php" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-6 text-center">
                                                <a class="btn btn-default delicious-btn mt-30" href="cadastrar.php">Criar Conta</a>
                                            </div>
                                            <div class="col-6 text-center">
                                                <button class="btn delicious-btn mt-30" type="submit">Entrar</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
